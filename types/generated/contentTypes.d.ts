...
export interface ApiChatChat extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Mensagens de chat entre usu\u00E1rios do sistema';
    displayName: 'Chat';
    pluralName: 'chats';
    singularName: 'chat';
  };
...
export interface ApiNotificationNotification
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['order_update', 'system', 'delivery']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Avalia\u00E7\u00F5es de produtos e pedidos';
    displayName: 'Review';
    pluralName: 'reviews';
    singularName: 'review';
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    chatsReceived: Schema.Attribute.Relation<'oneToMany', 'api::chat.chat'>;
    chatsSent: Schema.Attribute.Relation<'oneToMany', 'api::chat.chat'>;
    ...
    fullname: Schema.Attribute.String & Schema.Attribute.Configurable;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
