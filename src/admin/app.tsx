...
// @ts-ignore
// import AuthLogo from "/sellvex-transparent-branco-cropped.png";
// @ts-ignore
// import MenuLogo from "/sellvex-transparent-branco-cropped.png";
  ...
  config: {
    ...
    translations: {
      'pt-BR': {
          ...
          "Auth.form.button.login.strapi": "Entrar em Sellvex Eats",
          ...
          "Auth.form.email.placeholder": "seuemail@dominio.com",
          ...
          "Auth.form.register.news.label": "Mantenha-me atualizado sobre os novos recursos e as próximas melhorias Sellvex Eats",
          ...
          "Auth.form.welcome.subtitle": "Entrar na sua conta do Sellvex Eats",
          "Auth.form.welcome.title": "Bem-vindo(a) a Sellvex Eats!",
          ...
          "components.Select.placeholder": "Selecione...",
          ...
          "documentation.pages.SettingsPage.Button.save": "Salvar",
          "Email": "Email",
          "Files Upload": "Enviar arquivos",
          "global.localeToggle.label": "Alterar idioma",
          "HomePage.head.title": "Pagina inicial",
          "HomePage.roadmap": "Veja nosso roadmap",
          "HomePage.welcome.congrats": "Parabéns!",
          "HomePage.welcome.congrats.content": "Você está logado como o primeiro administrador. Para descobrir os recursos avançados fornecidos pelo Sellvex Eats,",
          ...
          "pages.PurchaseRelease.description": "A liberação de compra é um documento que autoriza a liberação de uma compra.",
          "pages.PurchaseRelease.title": "Liberação de compra",
          "Password": "Senha",
          "Provider": "Provedor",
          "ResetPasswordToken": "ResetPasswordToken",
          "pages.PurchaseRelease.perks1": "Adicionar muitos registros às liberações",
          "pages.PurchaseRelease.perks2": "Identifique rapidamente entradas com erros",
          "pages.PurchaseRelease.perks3": "Agende sua publicação ou publique manualmente",
          "Settings.page.PurchaseContent-history.description": "Reverter alterações instantaneamente",
          "Settings.page.PurchaseContent-history.perks1": "Navegue pelo histórico do seu conteúdo",
          "Settings.page.PurchaseContent-history.perks2": "Reverter alterações em um clique",
          "Settings.page.PurchaseContent-history.perks3": "Rastreie alterações em diferentes idiomas",
          ...
          "review-workflows.plugin.name": "Revisão de fluxo",
          "Role": "Role",
          ...
          "Settings.application.header": "Configurações gerais",
          ...
          "Settings.application.strapi-version": "versão do Sellvex Eats",
          "Settings.application.strapiVersion": "versão do Sellvex Eats",
          ...
          "Settings.permissions.users.lastname": "Sobrenome",
          ...
          "Settings.review-workflows.list.page.title": "Revisão de fluxo",
          "settings.page.purchase.description": "Gerencie seu processo de revisão de conteúdo",
          "settings.page.purchase.title": "Revisão de conteúdo",
          "settings.page.purchase.perks1": "Fluxo de revisão personalizável",
          "settings.page.purchase.perks2": "Gerencie permissões de usuário",
          "settings.page.purchase.perks3": "Suporte a webhooks",
          ...
          "admin.pages.MarketPlacePage.plugin.tooltip.madeByStrapi": "Criado por Sellvex Eats",
          "admin.pages.MarketPlacePage.plugin.tooltip.verified": "Extensão verificada por Sellvex Eats",
          ...
          "admin.pages.MarketPlacePage.subtitle": "Faça mais com o Sellvex Eats",
          "admin.pages.MarketPlacePage.tab-group.label": "Plugins e Provedores para Sellvex Eats",
          ...
          "app.components.BlockLink.blog.content": "Leia as últimas notícias do Sellvex Eats e seu ecossistema.",
          ...
          "app.components.BlockLink.tutorial.content": "Siga o passo-a-passo para usar e customizar o Sellvex Eats.",
          ...
          "app.components.HomePage.welcomeBlock.content.again": "Desejamos que você esteja progredindo em seu projeto... Fique por dentro das últimas novidades sobre o Sellvex Eats. Estamos sempre dando o nosso melhor para melhorar o produto sempre baseando-se em sua opinião.",
          ...
          "app.components.LeftMenu.navbrand.title": "Painel do Sellvex Eats",
          ...
          "app.components.MarketplaceBanner": "Descubra extensões da comunidade, e muito mais para dar início ao seu projeto, em Sellvex Eats Awesome.",
          "app.components.MarketplaceBanner.image.alt": "um logo de foguete do Sellvex Eats",
          ...
          "app.components.Users.SortPicker.sortby.lastname_asc": "Sobrenome (A a Z)",
          "app.components.Users.SortPicker.sortby.lastname_desc": "Sobrenome (Z a A)",
          ...
          "content-manager.content-types.api::store-attribute.store-attribute.id": "ID",
          "content-manager.content-types.api::store-attribute.store-attribute.name": "Nome",
          "content-manager.content-types.api::store-attribute.store-attribute.slug": "Slug",
          "content-manager.content-types.api::store-attribute.store-attribute.type": "Tipo",
          "content-manager.containers.list.table-headers.status": "Status",
          "Store Attribute": "Atributo da Loja",
          "Store Shipping Class": "Classe de Envio da Loja",
          "Store Shipping Method": "Método de Envio da Loja",
          "Store Shipping Zone": "Zona de Envio da Loja",
          "Store Subscription": "Assinatura da Loja",
          "Store Tag": "Tag da Loja",
          "Store Tenant": "Inquilino da Loja",
          "Store Notification": "Notificação da Loja",
          "Store Return": "Devolução da Loja",
          "Store Wishlist": "Lista de Desejos da Loja",
          "Store Customer": "Cliente da Loja",
          "content-manager.content-types.api::store-tenant.store-tenant.id": "ID",
          "content-manager.content-types.api::store-tenant.store-tenant.name": "Nome",
          "content-manager.content-types.api::store-tenant.store-tenant.slug": "Slug",
          "content-manager.content-types.api::store-tenant.store-tenant.domain": "Domínio",
          "Store Attribute Set": "Conjunto de Atributos da Loja",
          "Store Category": "Categoria da Loja",
          "Store Coupon": "Cupom da Loja",
          "Store Order": "Pedido da Loja",
          "Store Payment": "Pagamento da Loja",
          "Store Product": "Produto da Loja",
          "Store Review": "Avaliação da Loja",
          "Store Cart": "Carrinho de Compras",
          "Store Tax": "Imposto",
          "Store Attribute Term": "Termo de Atributo",
          "User": "Usuário",
          "clearLabel": "Limpar",
          ...
          "components.AutoReloadBlocker.description": "Execute o Sellvex Eats com um dos seguintes comandos:",
          ...
          "global.plugins.sentry.description": "Envie eventos de erro do Sellvex Eats para o Sentry.",
          ...
          "notification.version.update.message": "Uma nova versão do Sellvex Eats está disponível!",
      ...
      en: {
          ...
          "Auth.form.button.login.strapi": "Log in via Sellvex Eats",
          ...
          "Auth.form.register.news.label": "Keep me updated about new features & upcoming improvements Sellvex Eats.",
          "Auth.form.register.subtitle": "Credentials are only used to authenticate in Sellvex Eats. All saved data will be stored in your database.",
          "Auth.form.rememberMe.label": "Remember me",
          "Auth.form.username.label": "Username",
          "Auth.form.username.placeholder": "e.g. Kai_Doe",
          "Auth.form.welcome.subtitle": "Log in to your Sellvex Eats account",
          "Auth.form.welcome.title": "Welcome to Sellvex Eats!",
          ...
          "Settings.application.strapi-version": "Sellvex Eats version",
          "Settings.application.strapiVersion": "Sellvex Eats version",
          ...
          "Settings.permissions.users.listview.header.subtitle": "All the users who have access to the Sellvex Eats admin panel",
          ...
          "admin.pages.MarketPlacePage.offline.subtitle": "You need to be connected to the Internet to access Sellvex Eats Market.",
          ...
          "admin.pages.MarketPlacePage.plugin.tooltip.madeByStrapi": "Made by Sellvex Eats",
          "admin.pages.MarketPlacePage.plugin.tooltip.verified": "Plugin verified by Sellvex Eats",
          "admin.pages.MarketPlacePage.plugin.version": "Update your Sellvex Eats version: \"{strapiAppVersion}\" to: \"{versionRange}\"",
          "admin.pages.MarketPlacePage.plugin.version.null": "Unable to verify compatibility with your Sellvex Eats version: \"{strapiAppVersion}\"",
          ...
          "admin.pages.MarketPlacePage.subtitle": "Get more out of Sellvex Eats",
          "admin.pages.MarketPlacePage.tab-group.label": "Plugins and Providers for Sellvex Eats",
          ...
          "app.components.BlockLink.blog": "Blog",
          "app.components.BlockLink.blog.content": "Read the latest news about Sellvex Eats and the ecosystem.",
          "app.components.BlockLink.cloud": "Sellvex Eats Cloud",
          "app.components.BlockLink.cloud.content": "Fully-managed cloud hosting for your Sellvex Eats project.",
          ...
          "app.components.BlockLink.tutorial.content": "Follow step-by-step instructions to use and customize Sellvex Eats.",
          ...
          "app.components.FreeTrialWelcomeModal.description1": "For the next 30 days, you will have full access to advanced features like Content History, Releases and Single Sign-On (SSO) – everything you need to explore the power of Sellvex Eats CMS.",
          ...
          "app.components.LeftMenu.navbrand.title": "Sellvex Eats Dashboard",
          ...
          "app.components.MarketplaceBanner": "Discover plugins built by the community, and many more awesome things to kickstart your project, on Sellvex Eats Marketplace.",
          "app.components.MarketplaceBanner.image.alt": "A Sellvex Eats rocket logo",
          ...
          "app.components.NpsSurvey.banner-title": "How likely are you to recommend Sellvex Eats to a friend or colleague?",
          ...
          "components.AutoReloadBlocker.description": "Run Sellvex Eats with one of the following commands:",
          ...
          "global.plugins.sentry": "Sentry",
          "global.plugins.sentry.description": "Send Sellvex Eats error events to Sentry.",
          ...
          "notification.version.update.message": "A new version of Sellvex Eats is available!",
          ...
          "tours.overview.subtitle": "Follow the guided tour to get the most out of Sellvex Eats.",
          ...
          "tours.overview.strapiCloud.label": "Deploy your application to Sellvex Eats Cloud",
